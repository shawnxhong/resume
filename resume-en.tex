...
% \section{Basic Info}
% \begin{itemize}
%     \item Permanent Resident of Australia with a vision of international internet business. Experience in finance Industry.
%     \item Solid programming experience in C++, Python, Bash and Perl. Understanding of algorithms \& data structures.
%     \item Knowledge on both frontend \& backend developments. Experience with SQL/NoSQL storages. 
% \end{itemize}
...
\datedsubsection{\textbf{Coppersmith-Winograd Matrix Multiplication Module}}{C++}
\begin{itemize}
